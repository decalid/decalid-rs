...
use crate::events::model::{props2btree, EventPropertyMap};

/// RFC 7809 timezone reference prefix
pub const TIMEZONE_REFERENCE_PREFIX: &str = "TZID:";

/// Parse a timezone identifier into a Chrono timezone
pub fn parse_chrono_tz(tzid: &str) -> Result<ChronoTz> {
    tzid.parse()
        .map_err(|_| anyhow!("Invalid timezone identifier: {}", tzid))
}
